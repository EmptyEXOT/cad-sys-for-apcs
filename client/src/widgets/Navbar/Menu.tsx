...
const Menu: FC<MenuProps> = (props) => {
    ...
    return (
            <div className={classNames('fixed top-14 bg-neutral-200 py-2 md:hidden justify-center z-0 w-screen bg-opacity-50 backdrop-blur-md h-screen', props.isOpen ? cls.open : cls.close)}>
