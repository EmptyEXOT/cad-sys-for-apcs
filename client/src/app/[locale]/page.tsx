                    ...
                    <div className={classNames('flex flex-col gap-16')}>
                        <div className={classNames('flex flex-col gap-8 text-center')}>
                            ...
                            <p className={classNames('text-2xl leading-normal')}>
                                Our CAD platform offers a wide range of functionalities and tools to cater to every
                                aspect
                    ...
                    <div className={classNames('flex flex-col gap-10')}>
                        <div className={classNames('flex flex-col gap-8')}>
                            ...
                            <p className={classNames('text-2xl leading-normal')}>
                                ...
                                manufacturers. With our advanced computer-aided design tools, you can optimize your
                                process
                ...
                <Section id={Sections.Gallery} className={classNames('pt-24')}>
                    <div className={classNames('flex flex-col gap-20 text-center')}>
                        <div className={classNames('flex flex-col gap-8')}>
                            ...
                            <p className={classNames('text-2xl leading-normal')}>
                                Our digital platform empowers clients to effortlessly design their automated process
                                control
                                systems. With user-friendly tools and intuitive features, you can bring your ideas to
                                life
                                in no time.
                            </p>
                        </div>
                        ...
                        <div className={classNames('flex flex-col gap-4')}>
                            ...
                            <p className={classNames('text-2xl leading-normal')}>
                                Our platform seamlessly integrates with existing manufacturing systems, making it easy
                                to
                ...
                <Section id={Sections.Feature} className={classNames('pt-24')}>
                    <div className={classNames('flex flex-col gap-8')}>
                        ...
                        <p className={classNames('text-2xl leading-normal')}>
                            ...
                            enterprises, providing computer-aided design solutions for automated process control
                            systems.
